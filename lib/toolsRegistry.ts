...
export const toolsRegistry: ToolRegistryItem[] = [
  ...
  {
    "name": "Creator Monetization Funnel",
  ...
  {
    "name": "Idea Risk Analyzer",
    "slug": "idea-risk-analyzer",
    "category": "Idea Validation",
  ...
  {
    "name": "MVP Scope Calculator",
    "slug": "mvp-scope-calculator",
    "category": "Money & Pricing",
  ...
  {
    "name": "Opportunity Ranking Board",
  ...
  {
    "name": "Problem Severity Calculator",
    "slug": "problem-severity-calculator",
    "category": "Money & Pricing",
  ...
  {
    "name": "SaaS Pricing Calculator for B2B Startups",
  ...
  {
    "name": "Weekly Planning Constraints",
